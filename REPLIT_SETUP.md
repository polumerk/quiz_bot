...
5. **Проблемы с таймерами вопросов**
   - Используйте `/debug` для включения режима отладки
   - В логах будут видны детали работы таймеров
   - Поможет диагностировать проблемы с переходом между вопросами
...
**Или командой в чате:**
- `/debug` - переключает режим отладки

### Что показывает DEBUG:

- 🕰️ Детали работы таймеров вопросов
- 🎯 ID вопросов и привязки таймеров
- 📝 Обработку ответов пользователей
- 🔄 Переходы между вопросами
- 📊 Текущее состояние игры

**Полезно для диагностики проблем с таймерами!**
